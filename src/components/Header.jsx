...
function ModeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="[@media_not_(prefers-color-scheme:dark)]:stroke-insp-300 hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-sky-400/10" />
    </button>
  );
}
...
function MobileNavIcon({ open }) {
  return (
    <svg
      aria-hidden="true"
      className="h-3.5 w-3.5 overflow-visible stroke-slate-700 dark:stroke-slate-50"
      fill="none"
      strokeWidth={2}
      strokeLinecap="round"
    >
...
export function Header() {
  ...
  return (
    <header className=" py-4 dark:bg-slate-900">
      <Container>
